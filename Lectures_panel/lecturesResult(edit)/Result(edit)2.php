...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                <h3 class="text-dark mb-0" id="Semester-Result">+Add 2 Semester&nbsp;Result&nbsp;</h3>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sqlInsert = "INSERT INTO tbl_results_sem2 (Batch_id, enrollment_number, grade_subject_1, grade_subject_2, grade_subject_3, grade_subject_4, grade_subject_5, grade_subject_6, grade_subject_7, grade_subject_8, grade_subject_9, current_gpa)
