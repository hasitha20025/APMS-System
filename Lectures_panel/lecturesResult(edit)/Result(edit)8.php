...
<body id="page-top">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sqlInsert = "INSERT INTO tbl_results_sem8 (Batch_id, enrollment_number, grade_subject_1, grade_subject_2, grade_subject_3, grade_subject_4, grade_subject_5, grade_subject_6, grade_subject_7, grade_subject_8, grade_subject_9, current_gpa)
