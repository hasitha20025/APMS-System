...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                <h3 class="text-dark mb-0" id="Semester-Result">+Add 1 Semester&nbsp;Result&nbsp;</h3>
    ...
    echo "the index: " . $index_no;
    // Include your database connection code or establish a connection here
    // ...
