                    ...
                    <div class="container">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                // edith here
                                $sql_results = "SELECT * FROM tbl_results_sem7 WHERE enrollment_number = $user_id";
            ...
            <div class="container" style="margin-top: 20px;">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        $sql_semester2 = "SELECT current_gpa FROM tbl_results_sem7 WHERE enrollment_number = $user_id";
