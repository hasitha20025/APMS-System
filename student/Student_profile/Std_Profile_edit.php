<?php
ob_start();
include("C:/xampp/htdocs/APMS/student/parts/header.php");
...
<body id="page-top">
    ...
    // If 'user_id' is not set, check if it's set in the session


    // create SQL quary to get details

    $sql = "SELECT * from tbl_students WHERE stu_id =$user_id";
    ...
    <div class="d-flex flex-column" id="content-wrapper">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="rounded-circle" src="/APMS/images/student/<?php echo $image ?> " style="width: 150px;height: 150px;margin-left: 40%;margin-bottom: 20px;">
                                    <input class="border rounded-pill form-control form-control-sm" type="file" style="width: 300px;margin-left: 30%;" accept="image/*" name="new_image">
                                </div>
                                <div class="col-md-6">
        ...
        include('C:/xampp/htdocs/APMS/student/parts/footer.php');
        ?>
        <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['new_image']['name'])) {
                ...
                if ($new_image != "") {
                    ...
                    $destination_path = "C:/xampp/htdocs/APMS/images/student/" . $new_image; //wherew we want to sve phot & path added here
            ...
            if ($res2 == true) {
                //catagory updated,
                $_SESSION['updated-admin'] = "<div class='success'> success fully update student profile </div>";

                header("Location: Std_Profile_edit.php?user_id=" . $user_id);
                exit();
            } else {
                //not working well and redectl;  
